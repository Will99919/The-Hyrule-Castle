...
function getrandomcharacter(data) {
    ...
    var filtered = data.filter(function (personnage) {
        if (rarityRoll <= 50)
    ...
    var randomLink = Math.floor(Math.random() * filtered.length);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (mobs.hp <= 0) {
                        console.log("".concat(mobs.name, " has been defeated!"));
                        return [3 /*break*/, 2];
                    }
                    // Tour de l'ennemi
                    joueur.hp -= mobs.str;
                    console.log("".concat(mobs.name, " attacks ").concat(joueur.name, " for ").concat(mobs.str, " damage."));
                    return [3 /*break*/, 0];
